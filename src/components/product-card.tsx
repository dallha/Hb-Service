    ...
    <>
      ...
      <div className="px-0.5">
        ...
        <div className="flex items-center gap-2 mb-1 flex-wrap">
          {product.name.includes('HB_Service') && (
            <span className="inline-flex items-center rounded-none border border-[#D4AF37] bg-[#D4AF37]/10 px-1.5 py-0.5 text-[9px] uppercase tracking-widest text-[#D4AF37]">
              Création HB
            </span>
          )}
          {product.collection.slug === 'catalogue-2026' && !product.name.includes('HB_Service') && (
